...
import {
  ...
  Newspaper, HelpCircle, Star, CalendarCheck2, LayoutGrid, CalendarDays, CalendarRange, UserCog, CalendarOff
} from 'lucide-react';
...
const TILES: { id: AdminSection; label: string; description: string; icon: React.ReactNode }[] = [
  ...
  { id: 'schedule', label: 'Doctor Schedule', description: 'Block slots or a whole day off, per doctor', icon: <CalendarOff className="w-5 h-5" /> },
